💌 TEXTS DIRECTORY (public/assets/texts/)
=====================================

Put your daily love messages, diary logs, and letter templates here!

Key Files:
- `day-01.txt`
- `day-02.txt`
- ... up to `day-31.txt`
- `birthday-letter.txt` (the special, long letter shown on July 22nd)

How it works:
1. To customize a message for any day, create a simple text file inside this folder (e.g. `day-01.txt`) and type your message.
